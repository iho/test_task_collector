...
const (
	TelemetryService_Publish_FullMethodName = "/telemetry.TelemetryService/Publish"
)
...
type TelemetryServiceClient interface {
	Publish(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*PublishResponse, error)
}
...
func (c *telemetryServiceClient) Publish(ctx context.Context, in *Metric, opts ...grpc.CallOption) (*PublishResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PublishResponse)
	err := c.cc.Invoke(ctx, TelemetryService_Publish_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TelemetryServiceServer interface {
	Publish(context.Context, *Metric) (*PublishResponse, error)
...
func (UnimplementedTelemetryServiceServer) Publish(context.Context, *Metric) (*PublishResponse, error) {
...
func _TelemetryService_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Metric)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TelemetryServiceServer).Publish(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TelemetryService_Publish_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).Publish(ctx, req.(*Metric))
	}
...
var TelemetryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Publish",
			Handler:    _TelemetryService_Publish_Handler,
		},
	},
